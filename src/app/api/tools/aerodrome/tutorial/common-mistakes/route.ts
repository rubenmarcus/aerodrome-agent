...
export async function GET(request: Request) {
  try {
        ...
        mistakes: [
          {
            ...
            explanation: 'Adding tokens in unequal value ratios can lead to immediate impermanent loss.',
          ...
          },
          {
            ...
            solution: 'Choose the appropriate fee tier based on token volatility and expected trading volume.'
          },
          {
        ...
        mistakes: [
          {
            ...
            explanation: 'Unclaimed rewards don\'t compound and may be vulnerable to smart contract risks.',
        ...
        mistakes: [
          {
            ...
            solution: 'Consider longer lock periods for maximum benefits if you\'re committed to the protocol.'
          },
          {
    ...
    return NextResponse.json(
      { error: 'Failed to get common mistakes' },
      { status: 500 }
    );
  }
}